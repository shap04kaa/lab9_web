...
<header class="header">
        <div class="container">
            <div class="text-center py-5">
                <h1 class="name">Основы алгоритмов</h1>
                <h2>Шаповалов Александр Витальевич</h2>
                <h3>221-362</h3>
    ...
    <main class="main">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            {
                if ($argument <= 10) {
                    return (7 * $argument + 18);
                } elseif ($argument == 16) {
                    $error = 'error';
                    return 'error';
                    
                } elseif ($argument > 10 && $argument < 20) {
                    return (($argument - 17)/(8 - $argument * 0.5));
                } else {
                        return (($argument + 4) * ($argument - 7));
                    }
            }
